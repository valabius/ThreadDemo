...
//lib.ua-ru.net
public class UaDissertationsFactory extends DissertationsFactory {
    ...
    boolean t = true;
    String address;
    String firstAddress = "http://www.lib.ua-ru.net/disser/ua/metodika-vospitania.html";
    String addressWithSuffix = "http://www.lib.ua-ru.net/disser/ua/metodika-vospitania--p-";
